  ...
  return (
    <>
      ...
      <h1 className={[classes.IntroText, classes.LineHightLess].join(" ")}>
        Maria Santa's voice is very easy to be recognized.
        <br />
        How about the next 10 voices, can you recognize them?
      </h1>
      {/* <h1
          className={[
            classes.IntroText,
      ...
      <div className={classes.FlexBoxParentColumn}>
        <div className={classes.FlexBoxChild}>
          <Button linkToGo="/voicequiz-en" btnType="BtnNotFullGreen">
            START
          </Button>
        </div>
        <div className={classes.FlexBoxChild}>
...
export default voiceQuizIntroEn;
