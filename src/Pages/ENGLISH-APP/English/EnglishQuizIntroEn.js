  ...
  return (
    <>
      ...
      <h1 className={[classes.IntroText, classes.LineHightLess].join(" ")}>
        Despite her accent, Maria Santa speaks fluent English!
        <br />
        Now she is going to test yours!
      </h1>
      {/* <h1
          className={[
            classes.IntroText,
      ...
      <div className={classes.FlexBoxParentColumn}>
        <div className={classes.FlexBoxChild}>
          <Button linkToGo="/englishquiz-en" btnType="BtnNotFullGreen">
            START
          </Button>
        </div>
        <div className={classes.FlexBoxChild}>
...
export default englishQuizIntroEn;
